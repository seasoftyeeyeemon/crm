...
<body>
    <div id="app">
        ...
        <main>
            <div class="side-bar custom-width" id="side-bar">
            <div>
                    <img src="https://via.placeholder.com/100" alt="" class="border-radius margin-top">
                    <h5 class="margin-top-10px">{{Auth::user()->name}}</h5>
                </div>
                <div class="items-container margin-top-10px">
                    <a href="{{route('home')}}">
